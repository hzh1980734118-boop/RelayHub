...
}`)],-1)])])):r("",!0),o.value==="errors"?(l(),n("div",V,[s[17]||(s[17]=e("h2",null,"错误码",-1)),t(b,{data:y,style:{width:"100%"}},{default:d(()=>[t(p,{prop:"code",label:"状态码",width:"100"}),t(p,{prop:"type",label:"类型",width:"200"}),t(p,{prop:"desc",label:"说明"})]),_:1})])):r("",!0)])])]),t(g)])}}},J=h(F,[["__scopeId","data-v-a0eef2e5"]]);export{J as default};
